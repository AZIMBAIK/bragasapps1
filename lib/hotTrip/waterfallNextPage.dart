...
class nextPageViewWaterfall extends StatefulWidget {
  final int index;

  const nextPageViewWaterfall({Key? key, required this.index}) : super(key: key);

  @override
  State<nextPageViewWaterfall> createState() => _nextPageViewWaterfallState();
}

class _nextPageViewWaterfallState extends State<nextPageViewWaterfall> {
  Waterfall12 productController2 = Waterfall12();
  late int index;
