...
class baju extends StatefulWidget {
  @override
  State<baju> createState() => _bajuState();
}

class _bajuState extends State<baju> {
  Bajushop productController = Bajushop();
  Map<String, int> productQuantity = {};
  List<Map<String, dynamic>> cartItems = [];
  String selectedSize = "S"; // Default size value
  ...
  int calculateTotalPrice() {
    int totalPrice = 0;
    productQuantity.forEach((key, value) {
      var product = productController.bajushop.firstWhere((element) => element["k"] == key);
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('BAJU',style: TextStyle(fontWeight: FontWeight.bold,),),
        ),
        body: ListView.builder(
          itemCount: productController.bajushop.length,
          itemBuilder: (BuildContext context, int index) {
            var item = productController.bajushop[index];
