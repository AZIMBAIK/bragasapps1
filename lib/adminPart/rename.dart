...
//       // Filter documents safely checking for 'status22' and 'status23'
//       documents = documents.where((doc) => 
//         (doc.data() as Map<String, dynamic>).containsKey('status22') &&
//         (doc.data() as Map<String, dynamic>)['status22'] == 'Approve' &&
//         (doc.data() as Map<String, dynamic>).containsKey('status23') &&
//         (doc.data() as Map<String, dynamic>)['status23'] == 'Delivery'
//       ).toList();
...
//             // Filter out documents where 'status1' is not 'Approve' or 'status2' is not 'Delivery'
//             final filteredData = data.docs.where((doc) =>
//                 doc['status1'] == 'Approve' && doc['status2'] == 'Delivery');
//             return ListView.builder(
//               shrinkWrap: true,
//               physics: NeverScrollableScrollPhysics(),
//               itemCount: filteredData.length,
//               itemBuilder: (context, index) {
//                 final document = filteredData.elementAt(index);
