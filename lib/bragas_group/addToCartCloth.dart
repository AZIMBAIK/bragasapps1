...
class AddToCartCloth extends StatefulWidget {
  final Map<String, dynamic> productData;

  AddToCartCloth({required this.productData});
  @override
  _AddToCartClothState createState() => _AddToCartClothState();
}

class _AddToCartClothState extends State<AddToCartCloth> {
