...
class allPlaceOrderU2 extends StatelessWidget {
  ...
  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
    if (snapshot.connectionState == ConnectionState.waiting) {
      ...
      documents = documents.where((doc) {
        ...
        return data.containsKey('status22') &&
               data['status23'] == 'Prepare' && 
               data.containsKey('status23') &&
               (data['status22'] == 'Pending' || data['status22'] == 'Reject');
      }).toList();
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData) {
              ...
              final filteredData = data.docs.where((doc) {
                ...
                return docData['status2'] ==  'Prepare' && 
                       (docData['status1'] == 'Pending' || docData['status1'] == 'Reject');
              }).toList();
