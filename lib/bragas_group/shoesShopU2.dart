...
class shoesShopU2 extends StatefulWidget {
  @override
  _shoesShopU2State createState() => _shoesShopU2State();
}

class _shoesShopU2State extends State<shoesShopU2> {
  ...
  Future<List<DocumentSnapshot>> _fetchProducts() async {
    final QuerySnapshot querySnapshot =
        await _firestore.collection('RegProductShoes').get();
  ...
  Future<List<Map<String, dynamic>>> _fetchProductDetails(
    ...
    final DocumentSnapshot productDoc =
        await _firestore.collection('RegProductShoes').doc(productId).get();
